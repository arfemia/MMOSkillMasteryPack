...
# --- PER-PACK ---
$PackName          = 'MMOSkillMasteryPack'  # zip base name; the manifest Version is appended
$ExtraExcludeNames = @()                  # extra top-level file names to leave out of the zip
$ExtraExcludeDirs  = @('.unused-for-now') # extra top-level dir names (at the pack root) to skip
# ----------------
